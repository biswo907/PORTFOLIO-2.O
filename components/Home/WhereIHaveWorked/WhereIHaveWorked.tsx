...
import Squbix from "./Descriptions/Squbix";
import Pairalabs from "./Descriptions/Pairalabs";
export default function WhereIHaveWorked() {
  ...
  const [DescriptionJob, setDescriptionJob] = React.useState("Pairalabs");
  return (
    <div
      data-aos="fade-up"
      ...
      <div className="flex flex-col md:order-2 order-1 space-y-1 pl-8 md:pl-0 ">
        <div className="flex flex-row md:flex-col  ">
          <CompanyButton
            ...
            CompanyName="Pairalabs"
            BarPosition={40}
            BarAvobePosition={129}
            DescriptionJob="Pairalabs"
            CompanyNameBackgroundColorGreen={[
              false,
              true,
              false,
